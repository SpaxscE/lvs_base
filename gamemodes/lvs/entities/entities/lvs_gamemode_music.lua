	...
	list.Set( "lvsDynamicSongs", "Song2", {
		...
		songs = {
			...
			lowaction = {
				[1] = {"guitar1"},
				[2] = {"drum1","guitar2"},
				[3] = {"drum1","guitar2","guitar1"},
				[4] = {"bass","drum1","guitar1"},
				[5] = {"bass","drum1","guitar1","guitar2"},
				[6] = {"bass","drum1","guitar1","guitar2","voices"},
				[7] = {"bass","drum1","guitar1","synth","karamba","guitar2","voices"},
			},
			highaction = {
				[1] = {"guitar1"},
				...
				[7] = {"bass","drum2","guitar1","synth","karamba","guitar2","voices"},
			},
		},
		instruments = {
