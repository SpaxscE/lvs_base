...
ENT.lvsEditables = {
	[1] = {
		Category = "Body",
		Options = {
			[1] = { name = "MaxVelocity", type = "float", min = 50, max = 4000 },
			[2] = { name = "MaxVelocityReverse", type = "float", min = 50, max = 4000 },
			[3] = { name = "ThrottleRate", Category = "Body", type = "float", min = 0.1, max = 10 },
			[4] = { name = "BrakeRate", Category = "Body", type = "float", min = 0.1, max = 10 },
		},
	},
	[2] = {
		Category = "Engine",
	...
	[3] = {
		...
		Options = {
			[1] = { name = "TransGears", type = "int", min = 1, max = 12 },
			[2] = { name = "TransGearsReverse", type = "int", min = 1, max = 12 },
			[3] = { name = "TransMinGearHoldTime", type = "float", min = 0, max = 5 },
			[4] = { name = "TransShiftSpeed", type = "float", min = 0, max = 2 },
			[5] = { name = "TransShiftTorqueFactor", type = "float", min = 0, max = 1 },
			[6] = { name = "TransWobble", type = "float", min = 0, max = 255 },
			[7] = { name = "TransWobbleTime", type = "float", min = 0, max = 5 },
			[8] = { name = "TransWobbleFrequencyMultiplier", type = "float", min = 0, max = 5 },
			[9] = { name = "TransShiftSound", type = "string" },
			[10] = { name = "AutoReverseVelocity", type = "float", min = 0, max = 500 },
		},
	},
	[4] = {
		Category = "Steering",
		Options = {
			[1] = { name = "SteerSpeed", type = "float", min = 0.1, max = 12 },
			[2] = { name = "SteerReturnSpeed", type = "float", min = 0.1, max = 12 },
			[3] = { name = "FastSteerActiveVelocity", type = "float", min = 0, max = 4000 },
			[4] = { name = "FastSteerAngleClamp", type = "float", min = 1, max = 90 },
			[5] = { name = "FastSteerDeactivationDriftAngle", type = "float", min = 0, max = 90 },
		},
	},
	[5] = {
	...
	[7] = {
		...
		Options = {
			...
			[2] = { name = "ForceLinearMultiplierRacingTires", type = "float", min = 0, max = 10 },
			[3] = { name = "ForceAngleMultiplier", type = "float", min = 0, max = 10 },
			[4] = { name = "PhysicsDampingSpeed", type = "float", min = 0, max = 4000 },
	...
	[8] = {
		Category = "Wheel",
		Options = {
			[1] = { name = "WheelBrakeLockupRPM", type = "float", min = 0, max = 500 },
			[2] = { name = "WheelBrakeForce", type = "float", min = 0, max = 1000 },
			[3] = { name = "WheelSideForce", type = "float", min = 0, max = 10000 },
			[4] = { name = "WheelDownForce", type = "float", min = 0, max = 10000 },
		},
	},
}
