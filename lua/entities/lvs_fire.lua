...
if SERVER then
	...
	function ENT:Initialize()
		self:SetModel("models/xqm/afterburner1big.mdl")
...
function ENT:GetFireOrigin()
	local mins = self:OBBMins()

	return self:LocalToWorld( Vector(0,0,mins.z) )
end
...
function ENT:DrawTranslucent( flags )
	local Size = self:GetSize() * 160

	render.SetMaterial( GlowMat )
	render.DrawSprite( self:GetFireOrigin(), Size, Size, Color( 255, 150, 75, 255) )
end
